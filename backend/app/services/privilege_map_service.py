...
from app.models.models import UserNasPrivilegeMap, NetworkSegment, _build_segment_target_key
from app.schemas.schemas import UserNasPrivilegeMapOut, UserNasPrivilegeMapCreate
...
def to_out_schema(record: UserNasPrivilegeMap) -> UserNasPrivilegeMapOut:
    """Serialize UserNasPrivilegeMap ORM → Out schema, resolving related names."""
